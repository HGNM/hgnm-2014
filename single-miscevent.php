                    ...
                    if (have_rows('details')) {
                        while (have_rows('details')) {
                            ...
                            if (get_row_layout() == 'location') {
                                ...
                                if (get_sub_field('fn')) {
                                    echo '<span class="fn org">' . get_sub_field('fn') . '</span>';
                                }
                                if (get_sub_field('street-address') || get_sub_field('locality') || get_sub_field('region') || get_sub_field('postal-code') || get_sub_field('country-name')) {
                                    echo '<span class="adr">';
                                    if (get_sub_field('street-address')) {
                                        echo '<br /><span class="street-address">' . get_sub_field('street-address') . '</span>';
                                    }
                                    ...
                                    if (get_sub_field('region')) {
                                        echo '<span class="region">' . get_sub_field('region') . '</span>';
                                    }
                                    if (get_sub_field('postal-code')) {
                                        echo ' <span class="postal-code">' . get_sub_field('postal-code') . '</span>';
                                    }
                                    if (get_sub_field('country-name')) {
                                        echo '<br /><span class="country-name">' . get_sub_field('country-name') . '</span>';
                                    }
                                    echo '</span>';
                                }
                                echo '</p>';
