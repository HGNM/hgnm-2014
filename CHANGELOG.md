...
<a name="1.18.2"></a>
## [1.18.2](https://github.com/hgnm/hgnm-2014/compare/v1.18.1...v1.18.2) (2019-03-10)


### Bug Fixes

* **style:** Add grid/column mixin & simplify multi-column layouts ([f0293fc](https://github.com/hgnm/hgnm-2014/commit/f0293fc))



<a name="1.18.1"></a>
## [1.18.1](https://github.com/hgnm/hgnm-2014/compare/v1.18.0...v1.18.1) (2019-03-04)


### Bug Fixes

* **style:** Fix alignment of event lists on front page & events page ([8dd7c00](https://github.com/hgnm/hgnm-2014/commit/8dd7c00))
