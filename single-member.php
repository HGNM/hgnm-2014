						...
						<section class="secondary clearfix">
							...
							if ($upcomingcolloquia) {
								...
								foreach ($upcomingcolloquia as $item) {
									...
									echo '<p class="location map-popup">Room 6, <a href="https://www.google.com/maps/place/Music+Bldg,+Harvard+University,+Cambridge,+MA+02138/@42.3769058,-71.1170215,15z/data=!4m2!3m1!1s0x89e3774164253f4d:0x4139366065ac28ee" class="icon-location">Harvard University Music Building</a></p>';
									break;
								}
								echo '</div>';
							}
